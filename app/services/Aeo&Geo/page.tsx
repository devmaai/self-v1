  ...
  return (
    <>
      ...
      <FeatureList
              ...
              style="bullet"
              label="Proof"
              headline="Real Results for Independent Storage Operators"
              showDividers={false}
              items={[
                {
                  title: "",
                  desc: "+148% increase in organic move-ins (including AI-driven traffic)",
                },
                {
                  title: "",
                  desc: "#1 Map Pack ranking + frequent citations in AI answers for primary keywords",
                },
                {
                  title: "",
                  desc: "Zero reliance on paid aggregator leads for several clients after AEO/GEO rollout",
                },
              ]}
            />     
      <ContentBlock
